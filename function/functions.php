<?php
$conn=mysqli_connect("localhost", "root", "","dbbooks");
...
function getbooks(){
	...
	while($row=mysqli_fetch_array($result))
	{
		echo "<div class='col-lg-6 col-md-6'>
                            <div class='card'>
                                <img class='card-img' height='200px' width='200px' src='assets/images/".$row['image']."'>
                  ...
                  <div class='modal-dialog'>
                    <div class='modal-content'>
                      <div class='modal-header'>
                        ...
                        <img class='modal-body' style=\"margin-left:100px;margin-top:50px;\" height='100px' width='170px' src='assets/images/".$row['image']."'>
                        <h4 class='modal-title' style=\"margin-left:100px;margin-top:180px;\" id='myModalLabel'>".$row['title']."</h4>
                      </div>
